    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
          ...
          <li class="active"><a href="Course.html"> <i class="icon-padnote"></i>Course </a></li>
      ...
      <div class="page-content">
        ...
        <div class="page-header no-margin-bottom">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Course</h2>
          </div>
        </div>
        <!-- Breadcrumb-->
        <div class="container-fluid">
        ...
        <section class="no-padding-top">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="block">
                  <div class="title"><strong class="d-block">Course</strong><span class="d-block">Add Course and Qualification</span></div>
              ...
              <!-- Horizontal Form-->
               <div class="col-lg-6">
                <div class="block">
                  <div class="title"><strong class="d-block">Modules</strong><span class="d-block">Add Modules </span></div>
                  <div class="block-body">
                    <form>
                      <div class="form-group">
                        <label class="form-control-label">Modules</label>
                        <input type="text" placeholder="Course" class="form-control">
                      </div>
